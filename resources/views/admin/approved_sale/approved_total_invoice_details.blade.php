    ...
    <div class="container" id="printableArea">
        ...
        <div class="row table-responsive">
            <div class="col-xs-6 text-center">
                ...
                ?>
                <div><b>Words : </b>{{$numberTransformer->toWords($details->amount_of_total_outstanding)}}</div>
            </div>
            <div class="col-xs-4" style="float: right">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                        <td>&nbsp;&nbsp;{{$details->amount_of_total_price}}/-</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                        <td>&nbsp;&nbsp;{{$details->amount_of_current_amount}}/-</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                        <td>&nbsp;&nbsp;{{$details->amount_of_total_outstanding}}/-</td>
                    </tr>
                </table>
            </div>
        </div>
