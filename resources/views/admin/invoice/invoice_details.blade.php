...
@section('content')
    @php
        ...
        $pieces = explode(',',str_replace(str_split('[]""'),'',$details->pieces));
        $price = explode(',',str_replace(str_split('[]""'),'',$details->price));
        $total_price = explode(',',str_replace(str_split('[]""'),'',$details->total_price));
        $s =1;
    @endphp
    <div class="container" id="printableArea">
        ...
        <div class="row table-responsive">
            <div class="col-xs-6 text-center">
                ...
                ?>
                <div><b>Words : </b>{{$numberTransformer->toWords($details->total_amount)}}</div>
            </div>
            <div class="col-xs-4" style="float: right">
                <table>
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                        <td>&nbsp;&nbsp;{{$details->pieces_total}} pieces</td>
                    </tr>
                    <tr>
