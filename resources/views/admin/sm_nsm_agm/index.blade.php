@extends('master')
@section('sm_nsm_agm','active')
@section('sm_nsm_agm.index','active')
@section('content')
    @php
        $s = 1;
    @endphp
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-3 text-center">
                ...
                <div class="search_margin">
                    {!! Form::open(['route' => 'sm_nsm_agm.sale.search','method' => 'POST']) !!}
                    ...
                    @if($sales->count() ==! 0)
                        @foreach($sales as $sale)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success btn-xs btn-block" href="{{route('sm_nsm_agm.show',$sale->id)}}" target="_blank">Details</a>
                                    @if($sale->cancel == 0 && $sale->sm_approved == 0 && $sale->account_approved == 0 && $sale->md_approved == 0)
                                        <div class="modal fade" id="myModal_{{$sale->id}}" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    {!! Form::open(['route' => 'sm_nsm_agm.cancel','method' => 'POST']) !!}
                                    ...
                                    @endif
                                    @if($sale->sm_approved == 1 && $sale->cancel == 0)
                                        <br/>
                                        <button class="btn btn-primary btn-xs btn-block">Approved</button>
                                    @elseif($sale->sm_appproved == 0 && $sale->cancel == 0)
                                        <br/>
                                        <a class="btn btn-primary btn-xs btn-block" href="{{route('sm_nsm_agm.pending',$sale->id)}}">pending</a>
                                    @endif
                                    @if($sale->cancel == 0 && $sale->sm_approved == 0 && $sale->account_approved == 0 && $sale->md_approved == 0)
                                        <br/>
                                        <div class="modal fade" id="edit_modal_{{$sale->id}}" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    {!! Form::open(['class'=>'form-horizontal','route' => ['sm_nsm_agm.update',$sale->id],'method' => 'PATCH']) !!}
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                        ...
                                        <div class="modal fade" id="delete_modal_{{$sale->id}}" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    {!! Form::open(['route'=>['sm_nsm_agm.destroy',$sale->id],'method' => 'DELETE']) !!}
                                                    <div class="modal-footer">
