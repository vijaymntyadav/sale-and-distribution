@extends('master')
@section('additional_invoice','active')
@section('additional_invoice_index','active')
@section('content')
    @php
        ...
        $pieces = explode(',',str_replace(str_split('[]""'),'',$details->add_pieces));
        $price = explode(',',str_replace(str_split('[]""'),'',$details->price));
        $total_price = explode(',',str_replace(str_split('[]""'),'',$details->add_pieces_total_price));
        $s =1;
    @endphp
    <div class="container" id="printableArea">
        ...
        <div class="row table-responsive">
            <div class="col-xs-6 text-center">
                ...
                ?>
                <div><b>Words : </b>{{$numberTransformer->toWords($details->sum_of_add_pieces_total_price)}}</div>
            </div>
            <div class="col-xs-4" style="float: right">
                <table>
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                        <td>&nbsp;&nbsp;{{$details->add_pieces_total}} pieces</td>
                    </tr>
                    <tr>
                        <td><b>Total Price&nbsp;&nbsp;</b></td>
                        <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                        <td>&nbsp;&nbsp;{{$details->sum_of_add_pieces_total_price}}/-</td>
                    </tr>
                </table>
            </div>
        </div>
